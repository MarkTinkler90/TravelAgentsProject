...
public class CreateUK extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "---Select---", "Hotel", "House", "Other"}));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String ac, dest, sd, ed;
        int ID, pn, np, p, night;
        ac = jComboBox1.getSelectedItem().toString();
        dest = jTextField1.getText();
        pn = Integer.parseInt(jTextField2.getText());
        np = Integer.parseInt(jTextField3.getText());
        sd = jTextField4.getText();
        ed = jTextField5.getText();
        night = Integer.parseInt(jTextField6.getText());
        p = pn*np*night;
        ID = 12;
